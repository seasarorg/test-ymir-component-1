...
public abstract class AbstractBsYsRoleCQ extends AbstractConditionQuery {
     ...
     * {exists (select ROLE_ID from YS_ROLE_GROUP_USER where ...)} <br />
     ...
     *     public void query(YsRoleCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
     * </pre>
    ...
    public void existsYsRoleGroupUserList(SubQuery<YsRoleGroupUserCB> subQuery) {
        ...
        registerExistsReferrer(cb.query(), "ID", "ROLE_ID", subQueryPropertyName);
    }
    public abstract String keepId_ExistsReferrer_YsRoleGroupUserList(YsRoleGroupUserCQ subQuery);

    /**
     * Set up NotExistsReferrer (co-related sub-query). <br />
     * {not exists (select ROLE_ID from YS_ROLE_GROUP_USER where ...)} <br />
     * YS_ROLE_GROUP_USER as 'ysRoleGroupUserList'.
     * <pre>
    ...
    public void notExistsYsRoleGroupUserList(SubQuery<YsRoleGroupUserCB> subQuery) {
        ...
        registerNotExistsReferrer(cb.query(), "ID", "ROLE_ID", subQueryPropertyName);
    }
    public abstract String keepId_NotExistsReferrer_YsRoleGroupUserList(YsRoleGroupUserCQ subQuery);

    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select ROLE_ID from YS_ROLE_GROUP_USER where ...)} <br />
     * YS_ROLE_GROUP_USER as 'ysRoleGroupUserList'.
    ...
    public void inScopeYsRoleGroupUserList(SubQuery<YsRoleGroupUserCB> subQuery) {
        ...
        registerInScopeRelation(cb.query(), "ID", "ROLE_ID", subQueryPropertyName);
    }
    public abstract String keepId_InScopeRelation_YsRoleGroupUserList(YsRoleGroupUserCQ subQuery);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select ROLE_ID from YS_ROLE_GROUP_USER where ...)} <br />
     * YS_ROLE_GROUP_USER as 'ysRoleGroupUserList'.
    ...
    public void notInScopeYsRoleGroupUserList(SubQuery<YsRoleGroupUserCB> subQuery) {
        ...
        registerNotInScopeRelation(cb.query(), "ID", "ROLE_ID", subQueryPropertyName);
    }
    ...
    public void xsderiveYsRoleGroupUserList(String function, SubQuery<YsRoleGroupUserCB> subQuery, String aliasName, DerivedReferrerOption option) {
        ...
        registerSpecifyDerivedReferrer(function, cb.query(), "ID", "ROLE_ID", subQueryPropertyName, aliasName, option);
    }
    ...
    public void xqderiveYsRoleGroupUserList(String function, SubQuery<YsRoleGroupUserCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        ...
        registerQueryDerivedReferrer(function, cb.query(), "ID", "ROLE_ID", subQueryPropertyName, operand, value, parameterPropertyName, option);
    }
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB subCB) {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<YsRoleCB> scalar_NotEqual() {
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    protected void xscalarCondition(String function, SubQuery<YsRoleCB> subQuery, String operand) {
        assertObjectNotNull("subQuery<YsRoleCB>", subQuery);
        YsRoleCB cb = new YsRoleCB(); cb.xsetupForScalarCondition(this); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value.
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand);
    }
    public abstract String keepScalarCondition(YsRoleCQ subQuery);
    ...
    public abstract String keepMyselfInScopeRelation(YsRoleCQ subQuery);

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabCB() { return YsRoleCB.class.getName(); }
    protected String xabCQ() { return YsRoleCQ.class.getName(); }

...
public class BsYsUserCB extends AbstractConditionBean {
    ...
    public YsUserCQ getConditionQuery() { // public for parameter comment and internal
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;YsUserCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<YsUserCQ>() {
                ...
                public YsUserCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<YsUserCQ> {
        ...
        public HpSDRFunction<YsGroupUserCB, YsUserCQ> derivedYsGroupUserList() {
            ...
            return new HpSDRFunction<YsGroupUserCB, YsUserCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<YsGroupUserCB, YsUserCQ>() {
                public void setup(String function, SubQuery<YsGroupUserCB> subQuery, YsUserCQ cq, String aliasName, DerivedReferrerOption option) {
        ...
        public HpSDRFunction<YsRoleGroupUserCB, YsUserCQ> derivedYsRoleGroupUserList() {
            ...
            return new HpSDRFunction<YsRoleGroupUserCB, YsUserCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<YsRoleGroupUserCB, YsUserCQ>() {
                public void setup(String function, SubQuery<YsRoleGroupUserCB> subQuery, YsUserCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB cb) {
     *         cb.specify().<span style="color: #FD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB cb) {
    ...
    public HpColQyOperand<YsUserCB> columnQuery(final SpecifyQuery<YsUserCB> leftSpecifyQuery) {
        return new HpColQyOperand<YsUserCB>(new HpColQyHandler<YsUserCB>() {
            public HpCalculator handle(SpecifyQuery<YsUserCB> rightSp, String operand) {
                return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), leftSpecifyQuery, rightSp, operand);
            }
        });
    }

    protected YsUserCB xcreateColumnQueryCB() {
        YsUserCB cb = new YsUserCB();
        cb.xsetupForColumnQuery((YsUserCB)this);
        return cb;
    }
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB orCB) {
     ...
     *     public void query(YsUserCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;YsUserCB&gt;() {
     *             public void query(YsUserCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<YsUserCB> andQuery) {
        xorSQAP((YsUserCB)this, andQuery);
    }
    ...
    //                                                                        Purpose Type
    //                                                                        ============
    public void xsetupForColumnQuery(final YsUserCB mainCB) {
        xinheritSubQueryInfo(mainCB.localCQ());
        xchangePurposeSqlClause(HpCBPurpose.COLUMN_QUERY);

        // inherits a parent query to synchronize real name
        // (and also for suppressing query check) 
        specify().xsetSyncQyCall(new HpSpQyCall<YsUserCQ>() {
            public boolean has() { return true; }
            public YsUserCQ qy() { return mainCB.query(); }
        });
    }
    ...
    public void xsetupForVaryingUpdate() {
        ...
        final YsUserCB nonCheckCB = new YsUserCB();
        specify().xsetSyncQyCall(new HpSpQyCall<YsUserCQ>() {
            public boolean has() { return true; }
            public YsUserCQ qy() { return nonCheckCB.query(); }
        });
    }

...
public class BsYsRoleCB extends AbstractConditionBean {
    ...
    public YsRoleCQ getConditionQuery() { // public for parameter comment and internal
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;YsRoleCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<YsRoleCQ>() {
                ...
                public YsRoleCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<YsRoleCQ> {
        ...
        public HpSDRFunction<YsRoleGroupUserCB, YsRoleCQ> derivedYsRoleGroupUserList() {
            ...
            return new HpSDRFunction<YsRoleGroupUserCB, YsRoleCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<YsRoleGroupUserCB, YsRoleCQ>() {
                public void setup(String function, SubQuery<YsRoleGroupUserCB> subQuery, YsRoleCQ cq, String aliasName, DerivedReferrerOption option) {
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB cb) {
     *         cb.specify().<span style="color: #FD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB cb) {
    ...
    public HpColQyOperand<YsRoleCB> columnQuery(final SpecifyQuery<YsRoleCB> leftSpecifyQuery) {
        return new HpColQyOperand<YsRoleCB>(new HpColQyHandler<YsRoleCB>() {
            public HpCalculator handle(SpecifyQuery<YsRoleCB> rightSp, String operand) {
                return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), leftSpecifyQuery, rightSp, operand);
            }
        });
    }

    protected YsRoleCB xcreateColumnQueryCB() {
        YsRoleCB cb = new YsRoleCB();
        cb.xsetupForColumnQuery((YsRoleCB)this);
        return cb;
    }
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;YsRoleCB&gt;() {
     *     public void query(YsRoleCB orCB) {
     ...
     *     public void query(YsRoleCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;YsRoleCB&gt;() {
     *             public void query(YsRoleCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<YsRoleCB> andQuery) {
        xorSQAP((YsRoleCB)this, andQuery);
    }
    ...
    //                                                                        Purpose Type
    //                                                                        ============
    public void xsetupForColumnQuery(final YsRoleCB mainCB) {
        xinheritSubQueryInfo(mainCB.localCQ());
        xchangePurposeSqlClause(HpCBPurpose.COLUMN_QUERY);

        // inherits a parent query to synchronize real name
        // (and also for suppressing query check) 
        specify().xsetSyncQyCall(new HpSpQyCall<YsRoleCQ>() {
            public boolean has() { return true; }
            public YsRoleCQ qy() { return mainCB.query(); }
        });
    }
    ...
    public void xsetupForVaryingUpdate() {
        ...
        final YsRoleCB nonCheckCB = new YsRoleCB();
        specify().xsetSyncQyCall(new HpSpQyCall<YsRoleCQ>() {
            public boolean has() { return true; }
            public YsRoleCQ qy() { return nonCheckCB.query(); }
        });
    }

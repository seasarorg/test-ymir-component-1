...
public abstract class AbstractBsYsUserCQ extends AbstractConditionQuery {
    ...
    public void existsYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        ...
        registerExistsReferrer(cb.query(), "ID", "USER_ID", subQueryPropertyName);
    }
    public abstract String keepId_ExistsReferrer_YsGroupUserList(YsGroupUserCQ subQuery);

    /**
     * Set up ExistsReferrer (co-related sub-query). <br />
     * {exists (select USER_ID from YS_ROLE_GROUP_USER where ...)} <br />
     ...
     * {not exists (select USER_ID from YS_GROUP_USER where ...)} <br />
     * YS_GROUP_USER as 'ysGroupUserList'.
     * <pre>
    ...
    public void notExistsYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        ...
        registerNotExistsReferrer(cb.query(), "ID", "USER_ID", subQueryPropertyName);
    }
    public abstract String keepId_NotExistsReferrer_YsGroupUserList(YsGroupUserCQ subQuery);

    /**
     * Set up NotExistsReferrer (co-related sub-query). <br />
     * {not exists (select USER_ID from YS_ROLE_GROUP_USER where ...)} <br />
     * YS_ROLE_GROUP_USER as 'ysRoleGroupUserList'.
     * <pre>
     ...
     * {in (select USER_ID from YS_GROUP_USER where ...)} <br />
     * YS_GROUP_USER as 'ysGroupUserList'.
    ...
    public void inScopeYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        ...
        registerInScopeRelation(cb.query(), "ID", "USER_ID", subQueryPropertyName);
    }
    public abstract String keepId_InScopeRelation_YsGroupUserList(YsGroupUserCQ subQuery);

    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select USER_ID from YS_ROLE_GROUP_USER where ...)} <br />
     * YS_ROLE_GROUP_USER as 'ysRoleGroupUserList'.
     ...
     * {not in (select USER_ID from YS_GROUP_USER where ...)} <br />
     * YS_GROUP_USER as 'ysGroupUserList'.
    ...
    public void notInScopeYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        ...
        registerNotInScopeRelation(cb.query(), "ID", "USER_ID", subQueryPropertyName);
    }
    public abstract String keepId_NotInScopeRelation_YsGroupUserList(YsGroupUserCQ subQuery);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select USER_ID from YS_ROLE_GROUP_USER where ...)} <br />
     * YS_ROLE_GROUP_USER as 'ysRoleGroupUserList'.
    ...
    public void xsderiveYsGroupUserList(String function, SubQuery<YsGroupUserCB> subQuery, String aliasName, DerivedReferrerOption option) {
        ...
        registerSpecifyDerivedReferrer(function, cb.query(), "ID", "USER_ID", subQueryPropertyName, aliasName, option);
    }
    ...
    public void xqderiveYsGroupUserList(String function, SubQuery<YsGroupUserCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        ...
        registerQueryDerivedReferrer(function, cb.query(), "ID", "USER_ID", subQueryPropertyName, operand, value, parameterPropertyName, option);
    }
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB subCB) {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<YsUserCB> scalar_NotEqual() {
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB subCB) {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;YsUserCB&gt;() {
     *     public void query(YsUserCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
    ...
    protected void xscalarCondition(String function, SubQuery<YsUserCB> subQuery, String operand) {
        assertObjectNotNull("subQuery<YsUserCB>", subQuery);
        YsUserCB cb = new YsUserCB(); cb.xsetupForScalarCondition(this); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value.
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand);
    }
    public abstract String keepScalarCondition(YsUserCQ subQuery);
    ...
    public abstract String keepMyselfInScopeRelation(YsUserCQ subQuery);

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabCB() { return YsUserCB.class.getName(); }
    protected String xabCQ() { return YsUserCQ.class.getName(); }

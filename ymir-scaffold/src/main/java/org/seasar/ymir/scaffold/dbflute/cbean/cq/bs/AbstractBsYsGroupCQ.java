...
public abstract class AbstractBsYsGroupCQ extends AbstractConditionQuery {
    ...
    public void inScopeYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        ...
        registerInScopeSubQuery(cb.query(), "ID", "GROUP_ID", subQueryPropertyName);
    }
    ...
    public void notInScopeYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        ...
        registerNotInScopeSubQuery(cb.query(), "ID", "GROUP_ID", subQueryPropertyName);
    }
    ...
    /**
     * Set up 'exists' sub-query. {exists (select GROUP_ID from YS_GROUP_USER where ...)}
    ...
    public void existsYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        ...
        registerExistsSubQuery(cb.query(), "ID", "GROUP_ID", subQueryPropertyName);
    }
    public abstract String keepId_ExistsSubQuery_YsGroupUserList(YsGroupUserCQ subQuery);

    /**
     * Set up 'exists' sub-query. {exists (select GROUP_ID from YS_ROLE_GROUP_USER where ...)}
    ...
    /**
     * Set up 'not exists' sub-query. {not exists (select GROUP_ID from YS_GROUP_USER where ...)}
    ...
    public void notExistsYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        ...
        registerNotExistsSubQuery(cb.query(), "ID", "GROUP_ID", subQueryPropertyName);
    }
    public abstract String keepId_NotExistsSubQuery_YsGroupUserList(YsGroupUserCQ subQuery);

    /**
     * Set up 'not exists' sub-query. {not exists (select GROUP_ID from YS_ROLE_GROUP_USER where ...)}
    ...
    public void xsderiveYsGroupUserList(String function, SubQuery<YsGroupUserCB> subQuery, String aliasName) {
        ...
        registerSpecifyDerivedReferrer(function, cb.query(), "ID", "GROUP_ID", subQueryPropertyName, aliasName);
    }
    ...
    public void xqderiveYsGroupUserList(String function, SubQuery<YsGroupUserCB> subQuery, String operand, Object value) {
        ...
        registerQueryDerivedReferrer(function, cb.query(), "ID", "GROUP_ID", subQueryPropertyName, operand, value, parameterPropertyName);
    }
    ...
    protected void xscalarSubQuery(String function, SubQuery<YsGroupCB> subQuery, String operand) {
        assertObjectNotNull("subQuery<YsGroupCB>", subQuery);
        YsGroupCB cb = new YsGroupCB(); cb.xsetupForScalarSubQuery(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarSubQuery(cb.query()); // for saving query-value.
        registerScalarSubQuery(function, cb.query(), subQueryPropertyName, operand);
    }
    public abstract String keepScalarSubQuery(YsGroupCQ subQuery);
    ...
    public abstract String keepMyselfInScopeSubQuery(YsGroupCQ subQuery);

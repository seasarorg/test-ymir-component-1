...
/**
 * The abstract condition-query of YS_USER.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsYsUserCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsYsUserCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public void inScopeYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        ...
        YsGroupUserCB cb = new YsGroupUserCB(); cb.xsetupForInScopeSubQuery(); subQuery.query(cb);
        String subQueryPropertyName = keepId_InScopeSubQuery_YsGroupUserList(cb.query()); // for saving query-value.
        registerInScopeSubQuery(cb.query(), "ID", "USER_ID", subQueryPropertyName);
    }
    public abstract String keepId_InScopeSubQuery_YsGroupUserList(YsGroupUserCQ subQuery);
    ...
    public void notInScopeYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        assertObjectNotNull("subQuery<YsGroupUserCB>", subQuery);
        YsGroupUserCB cb = new YsGroupUserCB(); cb.xsetupForInScopeSubQuery(); subQuery.query(cb);
        String subQueryPropertyName = keepId_NotInScopeSubQuery_YsGroupUserList(cb.query()); // for saving query-value.
        registerNotInScopeSubQuery(cb.query(), "ID", "USER_ID", subQueryPropertyName);
    }
    public abstract String keepId_NotInScopeSubQuery_YsGroupUserList(YsGroupUserCQ subQuery);
    ...
    /**
     * Set up 'exists' sub-query. {exists (select USER_ID from YS_GROUP_USER where ...)}
     * @param subQuery The sub-query of Id_ExistsSubQuery_YsGroupUserList for 'exists'. (NotNull)
     */
    public void existsYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        assertObjectNotNull("subQuery<YsGroupUserCB>", subQuery);
        YsGroupUserCB cb = new YsGroupUserCB(); cb.xsetupForExistsSubQuery(); subQuery.query(cb);
        String subQueryPropertyName = keepId_ExistsSubQuery_YsGroupUserList(cb.query()); // for saving query-value.
        registerExistsSubQuery(cb.query(), "ID", "USER_ID", subQueryPropertyName);
    }
    public abstract String keepId_ExistsSubQuery_YsGroupUserList(YsGroupUserCQ subQuery);

    /**
     * Set up 'exists' sub-query. {exists (select USER_ID from YS_ROLE_GROUP_USER where ...)}
    ...
    /**
     * Set up 'not exists' sub-query. {not exists (select USER_ID from YS_GROUP_USER where ...)}
     * @param subQuery The sub-query of Id_NotExistsSubQuery_YsGroupUserList for 'not exists'. (NotNull)
     */
    public void notExistsYsGroupUserList(SubQuery<YsGroupUserCB> subQuery) {
        assertObjectNotNull("subQuery<YsGroupUserCB>", subQuery);
        YsGroupUserCB cb = new YsGroupUserCB(); cb.xsetupForExistsSubQuery(); subQuery.query(cb);
        String subQueryPropertyName = keepId_NotExistsSubQuery_YsGroupUserList(cb.query()); // for saving query-value.
        registerNotExistsSubQuery(cb.query(), "ID", "USER_ID", subQueryPropertyName);
    }
    public abstract String keepId_NotExistsSubQuery_YsGroupUserList(YsGroupUserCQ subQuery);

    /**
     * Set up 'not exists' sub-query. {not exists (select USER_ID from YS_ROLE_GROUP_USER where ...)}
    ...
    public void xsderiveYsGroupUserList(String function, SubQuery<YsGroupUserCB> subQuery, String aliasName) {
        assertObjectNotNull("subQuery<YsGroupUserCB>", subQuery);
        YsGroupUserCB cb = new YsGroupUserCB(); cb.xsetupForDerivedReferrer(); subQuery.query(cb);
        String subQueryPropertyName = keepId_SpecifyDerivedReferrer_YsGroupUserList(cb.query()); // for saving query-value.
        registerSpecifyDerivedReferrer(function, cb.query(), "ID", "USER_ID", subQueryPropertyName, aliasName);
    }
    ...
    protected HpQDRFunction<YsGroupUserCB> xcreateQDRFunctionYsGroupUserList() {
        return new HpQDRFunction<YsGroupUserCB>(new HpQDRSetupper<YsGroupUserCB>() {
            public void setup(String function, SubQuery<YsGroupUserCB> subQuery, String operand, Object value) {
                xqderiveYsGroupUserList(function, subQuery, operand, value);
            }
        });
    }
    public void xqderiveYsGroupUserList(String function, SubQuery<YsGroupUserCB> subQuery, String operand, Object value) {
        assertObjectNotNull("subQuery<YsGroupUserCB>", subQuery);
        YsGroupUserCB cb = new YsGroupUserCB(); cb.xsetupForDerivedReferrer(); subQuery.query(cb);
        ...
        registerQueryDerivedReferrer(function, cb.query(), "ID", "USER_ID", subQueryPropertyName, operand, value, parameterPropertyName);
    }
    ...
    protected void doSetMailAddress_NotEqual(String mailAddress) {
        regMailAddress(CK_NE, mailAddress);
    }
    ...
    //                                                                     Scalar SubQuery
    //                                                                     ===============
    public HpSSQFunction<YsUserCB> scalar_Equal() {
        return xcreateSSQFunction("=");
    }

    public HpSSQFunction<YsUserCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(">=");
    }

    public HpSSQFunction<YsUserCB> scalar_GreaterThan() {
        return xcreateSSQFunction(">");
    }

    public HpSSQFunction<YsUserCB> scalar_LessEqual() {
        return xcreateSSQFunction("<=");
    }
    
    public HpSSQFunction<YsUserCB> scalar_LessThan() {
        return xcreateSSQFunction("<");
    }
    
    protected HpSSQFunction<YsUserCB> xcreateSSQFunction(final String operand) {
        return new HpSSQFunction<YsUserCB>(new HpSSQSetupper<YsUserCB>() {
            public void setup(String function, SubQuery<YsUserCB> subQuery) {
                xscalarSubQuery(function, subQuery, operand);
            }
        });
    }

    protected void xscalarSubQuery(String function, SubQuery<YsUserCB> subQuery, String operand) {
        assertObjectNotNull("subQuery<YsUserCB>", subQuery);
        YsUserCB cb = new YsUserCB(); cb.xsetupForScalarSubQuery(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarSubQuery(cb.query()); // for saving query-value.
        registerScalarSubQuery(function, cb.query(), subQueryPropertyName, operand);
    }
    public abstract String keepScalarSubQuery(YsUserCQ subQuery);
     ...
     */
    public void myselfInScope(SubQuery<YsUserCB> subQuery) {
        assertObjectNotNull("subQuery<YsUserCB>", subQuery);
    ...
    public abstract String keepMyselfInScopeSubQuery(YsUserCQ subQuery);

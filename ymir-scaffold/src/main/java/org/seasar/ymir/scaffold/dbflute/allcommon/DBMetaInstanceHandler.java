...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("YS_GROUP", "org.seasar.ymir.scaffold.dbflute.bsentity.dbmeta.YsGroupDbm");
        tmpMap.put("YS_GROUP_USER", "org.seasar.ymir.scaffold.dbflute.bsentity.dbmeta.YsGroupUserDbm");
        tmpMap.put("YS_ROLE", "org.seasar.ymir.scaffold.dbflute.bsentity.dbmeta.YsRoleDbm");
        tmpMap.put("YS_ROLE_GROUP_USER", "org.seasar.ymir.scaffold.dbflute.bsentity.dbmeta.YsRoleGroupUserDbm");
        tmpMap.put("YS_USER", "org.seasar.ymir.scaffold.dbflute.bsentity.dbmeta.YsUserDbm");
